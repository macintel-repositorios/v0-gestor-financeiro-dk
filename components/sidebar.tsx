        ...
        <div className="flex h-16 items-center justify-between px-4 border-b border-[hsl(var(--sidebar-border))]">
          {(!isCollapsed || isMobile) && (
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-sm font-bold text-white tracking-tight font-display">Gestor Financeiro</h2>
        ...
        <ScrollArea className="flex-1 px-3 min-h-0">
          <div className="py-2 space-y-4">
            {Object.entries(groupedItems).map(([group, items]) => (
              <div key={group}>
                {(!isCollapsed || isMobile) && (
                  <p className="text-[10px] font-bold uppercase tracking-wider text-[hsl(var(--sidebar-foreground))]/40 px-3 mb-2 font-display">
